...
export function CheckoutDialog() {
  ...
  return (
    <Dialog open={checkoutOpen} onOpenChange={(o) => !o && close()}>
      <DialogContent className="!max-w-2xl !w-[96vw] sm:!max-w-2xl h-[92vh] p-0 gap-0 overflow-hidden bg-background rounded-lg">
            ...
            <div className="p-7 lg:p-9 flex flex-col h-full">
              ...
              <form onSubmit={submit} className="mt-4 space-y-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea id="notes" value={form.notes} onChange={(e) => updateField('notes', e.target.value)} className="rounded-sm text-xs resize-none h-20" placeholder="أي ملاحظات إضافية..." />
                </div>
